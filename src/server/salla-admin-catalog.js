...
export async function listSallaAdminCatalog(client = { query }) {
  ...
  const result = await client.query(
    `SELECT template_key AS "templateKey",subject,body,settings,updated_at AS "updatedAt"
...
export async function saveSallaAdminTemplate({ adminId, templateKey, channel, subject, body, settings = {} }) {
  ...
  const result = await query(
    `INSERT INTO admin_message_templates
     ...
     VALUES ($1,$2,$3,$4,$5,$6,$7::jsonb,'[]'::jsonb,$8::jsonb,true,true,$9)
