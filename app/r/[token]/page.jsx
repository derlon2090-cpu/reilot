...
export default async function RenewalTrackingPage({ params }) {
  ...
  return <main dir="rtl" style={{fontFamily:"IBM Plex Sans Arabic, sans-serif",maxWidth:680,margin:"70px auto",padding:24}}>
    <section style={{border:"1px solid #E8F1F0",borderRadius:24,padding:32,boxShadow:"0 18px 50px rgba(6, 43, 40,.08)"}}>
      <img className="renvix-logo brand-logo-image--compact" src="/assets/renvix-logo-deep-teal.svg" alt="Renvix" width="190" height="55" style={{maxWidth:"60%"}} />
