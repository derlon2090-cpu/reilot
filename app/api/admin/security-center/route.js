...
export async function GET(request) {
  ...
  return Response.json({
    ...
    incidentCounts: incidentCounts.rows[0], honeypot: { ...honeypotStats.rows[0], countries: countries.rows, asns: asns.rows, paths: paths.rows },
    ...
    assurance: "No known critical issues detected"
