  ...
  return (
    <html lang="ar" dir="rtl" className={alexandria.variable} suppressHydrationWarning>
      <head>
        ...
        <link rel="stylesheet" href="/app/styles/globals.css?v=20260911-logo-order-v153" />
        <link rel="stylesheet" href="/app/styles/dark-system.css?v=20260813-preferences-v109" />
        <link rel="stylesheet" href="/app/styles/approved-templates-reference.css?v=20260911-logo-order-v153" />
        <link rel="stylesheet" href="/app/styles/identity-system.css?v=20260911-logo-order-v153" />
      </head>
      <body>
        {children}
        <Script type="module" src="/app/app.js?v=20260911-logo-order-v153" strategy="afterInteractive" />
      </body>
    </html>
  );
}
