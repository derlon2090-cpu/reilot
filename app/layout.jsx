  ...
  return (
    <html lang="ar" dir="rtl" className={alexandria.variable} suppressHydrationWarning>
      <head>
        ...
        <link rel="modulepreload" href="/app/app.js?v=20260924-text-box-selection" crossOrigin="anonymous" />
        ...
        <link rel="stylesheet" href="/app/styles/globals.css?v=20260924-text-box-selection" />
      ...
      <body>
        {children}
        <Script type="module" src="/app/app.js?v=20260924-text-box-selection" strategy="afterInteractive" />
      </body>
    </html>
  );
}
