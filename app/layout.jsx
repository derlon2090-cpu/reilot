  ...
  return (
    <html lang="ar" dir="rtl" className={alexandria.variable} suppressHydrationWarning>
      <head>
        ...
        <link rel="modulepreload" href="/app/app.js?v=20260924-bidi-box-alignment" crossOrigin="anonymous" />
        ...
        <link rel="stylesheet" href="/app/styles/globals.css?v=20260924-bidi-box-alignment" />
      ...
      <body>
        {children}
        <Script type="module" src="/app/app.js?v=20260924-bidi-box-alignment" strategy="afterInteractive" />
      </body>
    </html>
  );
}
