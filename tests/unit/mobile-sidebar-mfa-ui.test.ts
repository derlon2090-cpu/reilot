...
describe("mobile sidebar and MFA UI contracts", () => {
  ...
  it("keeps every public authentication form paired with its own responsive illustration", () => {
    ...
    expect(stylesSource).toContain(".auth-relocated-feature--channels::before{width:47px;transform:rotate(26.3deg)");
    expect(stylesSource).toContain(".auth-relocated-feature--security::before{width:49px;transform:rotate(32.5deg)");
