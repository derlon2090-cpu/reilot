  ...
  return (
    <html lang="ar" dir="rtl" className={alexandria.variable} suppressHydrationWarning>
      <head>
        ...
        <link rel="modulepreload" href="/app/app.js?v=20260924-existing-box-caret" crossOrigin="anonymous" />
        ...
        <link rel="stylesheet" href="/app/styles/globals.css?v=20260924-existing-box-caret" />
      ...
      <body>
        {children}
        <Script type="module" src="/app/app.js?v=20260924-existing-box-caret" strategy="afterInteractive" />
      </body>
    </html>
  );
}
