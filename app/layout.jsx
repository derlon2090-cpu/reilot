  ...
  return (
    <html lang="ar" dir="rtl" suppressHydrationWarning>
      <head>
        ...
        <link rel="stylesheet" href="/app/styles/globals.css?v=20260812-renewal-email-studio-v98" />
        <link rel="stylesheet" href="/app/styles/dark-system.css?v=20260811-auth-independent-v80" />
      </head>
      <body>
        {children}
        <Script type="module" src="/app/app.js?v=20260812-renewal-email-studio-v98" strategy="afterInteractive" />
      </body>
    </html>
  );
}
