  ...
  return (
    <html lang="ar" dir="rtl" className={alexandria.variable} suppressHydrationWarning>
      <head>
        ...
        <link rel="modulepreload" href="/app/app.js?v=20260911-brand-surfaces-v159" crossOrigin="anonymous" />
        ...
        <link rel="stylesheet" href="/app/styles/globals.css?v=20260911-brand-surfaces-v159" />
      ...
      <body>
        {children}
        <Script type="module" src="/app/app.js?v=20260911-brand-surfaces-v159" strategy="afterInteractive" />
      </body>
    </html>
  );
}
