...
export function buildEmailTemplateCodeMessages(input, resolvedContext = null) {
  ...
  const system = [
    ...
    ...(input.templateContext?.templateType === "campaign_email" ? [
      ...
      "رتّب البطاقات بحيث تكون البطاقة الأولى بعرض كامل في الأعلى، ثم البطاقات التالية بطاقتين في كل صف حسب ترتيبها، مع جعل البطاقة الأخيرة بعرض كامل إذا كان عدد البطاقات السفلية فرديًا.",
      input.brandLogoUrl
