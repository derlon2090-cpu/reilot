  ...
  return (
    <html lang="ar" dir="rtl" suppressHydrationWarning>
      <head>
        ...
        <link rel="stylesheet" href="/app/styles/globals.css?v=20260811-auth-stable-load-v37" />
        <script type="module" src="/app/app.js?v=20260811-auth-stable-load-v37"></script>
      </head>
      <body>{children}</body>
    </html>
  );
