  ...
  return (
    <html lang="ar" dir="rtl" className={alexandria.variable} suppressHydrationWarning>
      <head>
        ...
        <link rel="modulepreload" href="/app/app.js?v=20260924-storage-security-ux" crossOrigin="anonymous" />
        ...
        <link rel="stylesheet" href="/app/styles/globals.css?v=20260924-storage-security-ux" />
      ...
      <body>
        {children}
        <Script type="module" src="/app/app.js?v=20260924-storage-security-ux" strategy="afterInteractive" />
      </body>
    </html>
  );
}
