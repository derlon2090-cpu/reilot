  ...
  return (
    <html lang="ar" dir="rtl" className={alexandria.variable} suppressHydrationWarning>
      <head>
        ...
        <link rel="modulepreload" href="/app/app.js?v=20260925-campaign-sharing-v1" crossOrigin="anonymous" />
      ...
      <body>
        {children}
        <Script type="module" src="/app/app.js?v=20260925-campaign-sharing-v1" strategy="afterInteractive" />
      </body>
    </html>
  );
}
