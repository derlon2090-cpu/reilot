...
export function buildEmailTemplateCodeMessages(input, resolvedContext = null) {
  ...
  const system = [
    ...
    ...(input.templateContext?.templateType === "campaign_email" ? [
      "في بريد الحملات، حافظ دائمًا على هوية المتجر ونص المعاينة والقسم الرئيسي وعنوان الحملة ونصها وعنوان التفاصيل وجميع البطاقات بالترتيب مع صورها أو مواضعها وعناوينها ونصوصها وأزرارها وروابطها وروابط التواصل والتذييل ورابط {{unsubscribe_url}}. لا تنشئ صورة غلاف مستقلة؛ الصور تخص البطاقات فقط. غيّر التصميم والتوزيع دون حذف أي عنصر من هذه العناصر.",
      "رتّب جميع البطاقات بطاقتين في كل صف من أول بطاقة إلى آخر بطاقة مع الحفاظ على ترتيبها. إذا كان العدد فرديًا فتبقى البطاقة الأخيرة بعرض نصف الصف مع خلية مرافقة فارغة، ولا تجعل أي بطاقة بعرض كامل.",
      input.brandLogoUrl
