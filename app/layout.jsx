  ...
  return (
    <html lang="ar" dir="rtl" className={alexandria.variable} suppressHydrationWarning>
      <head>
        ...
        <link rel="modulepreload" href="/app/app.js?v=20260913-auth-renvix-v160" crossOrigin="anonymous" />
        ...
        <link rel="stylesheet" href="/app/styles/globals.css?v=20260913-auth-renvix-v160" />
        ...
        <link rel="stylesheet" href="/app/styles/auth-renvix.css?v=20260913-auth-renvix-v160" media="(min-width: 744px)" />
      </head>
      <body>
        {children}
        <Script type="module" src="/app/app.js?v=20260913-auth-renvix-v160" strategy="afterInteractive" />
      </body>
    </html>
  );
}
